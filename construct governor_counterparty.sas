proc sql;
create table temp1 as select distinct stock_code_1,event_date,coparty_province,coparty_city from broker.governor_event_14
where coparty_city^='';
quit;
...
proc sql;
create table temp6 as select distinct a.*,sum(b.netBS*BS) as home_notcoparty from temp6 a left join temp5 b
on a.stock_code_1=b.stock_code_1 and a.event_date=b.event_date and a.date=b.date and b.coparty_type<2 and b.branch_type=2
group by b.stock_code_1,b.event_date,b.date;
quit;
...
proc sql;
create table temp6 as select distinct a.*,sum(b.netBS*BS) as coparty_nothome from temp6 a left join temp5 b
on a.stock_code_1=b.stock_code_1 and a.event_date=b.event_date and a.date=b.date and b.coparty_type=2 and b.branch_type<2
group by b.stock_code_1,b.event_date,b.date;
quit;
...
data temp6;
set temp6;
if coparty_nothome=. then coparty_nothome=0;
if coparty_city=. then coparty_city=0;
if homecity=. then homecity=0;
if home_notcoparty=. then home_notcoparty=0;
...
coparty_nothome=coparty_nothome/avg_vol;
...
proc sql;
create table temp8 as select distinct stock_code_1,event_date,mean(coparty_nothome) as coparty_nothome_avg,mean(coparty_city) as coparty_city_avg,mean(homecity) as homecity_avg,mean(home_notcoparty) as home_notcoparty_avg,mean(outall) as outall_avg
from temp6
group by stock_code_1, event_date;
quit;
...
,a.coparty_nothome-b.coparty_nothome_avg as coparty_nothome_imb_adj
,a.coparty_city-b.coparty_city_avg as coparty_city_imb_adj
,a.homecity-b.homecity_avg as homecity_imb_adj
,a.home_notcoparty-b.home_notcoparty_avg as home_notcoparty_imb_adj
...
proc sql;
create table broker.all_eerbl_60d_imb_governor as select distinct a.*,b.coparty_nothome_imb_adj,b.coparty_city_imb_adj,b.homecity_imb_adj,b.home_notcoparty_imb_adj,b.outall_imb_adj from broker.all_eerbl_60d_imb a,temp6 b
