...
proc sql;
create table &event._60d_imb as select distinct a.* from broker.&event._60d_imb a,broker.&event._nosuspension b
where a.stock_code_1=b.stock_code_1 and a.event_date=b.event_date;
quit;
...
proc sql;
create table temp1_w as select distinct a.*,b.F5_T0401w as closeprc,F11_T0401W as F11_T0401D,F12_T0401W as F12_T0401D,F13_T0401W as F13_T0401D,F14_T0401W as F14_T0401D,7-input(F9_T0401W,6.)*2 as BS,F17_T0401W+F18_T0401W as netBS,branch_province,branch_city,head_province,head_city,branch_type,head_type
from temp1_w a left join broker.T_0401W_1 b
on a.stock_code_1=b.F3_T0401W and a.startdate=b.startdate and a.enddate=b.enddate and b.F9_T0401W>'2';
quit;

proc sql;
create table temp1_d as select distinct a.*,b.F5_T0401D as closeprc,F11_T0401D,F12_T0401D,F13_T0401D,F14_T0401D,7-input(F9_T0401D,6.)*2 as BS,F17_T0401D+F18_T0401D as netBS,branch_province,branch_city,head_province,head_city,branch_type,head_type
from temp1_d a left join broker.T_0401D_1 b
...
drop date time_trade;
run;

proc sort;
by stock_code_1 F11_T0401d F12_T0401d F13_T0401d F14_T0401d startdate enddate event_date;
run;
...
proc sql;
create table Event_appearance_wd as select distinct stock_code_1,F11_T0401d,F12_T0401d,F13_T0401d,F14_T0401d,count(distinct event_date) as count,branch_province,branch_city,head_province,head_city,branch_type,head_type
from temp2
...
data Freq_appearance_wd;
set Event_appearance_wd;
if count=1;
if F11_T0401d^='';
run;

data Freq_appearance_wd;
set Freq_appearance_wd;
...
proc sql;
create table distribution as select distinct count as Frequency,count(count) as count,sum(count) as Sum from event_appearance_wd
group by count;
quit;

proc sql;
create table T_0401W_1 as select distinct a.* from broker.T_0401w_1 a,Freq_appearance_wd b
where a.F3_T0401W=b.stock_code_1 and a.F11_T0401W=b.F11_T0401d and a.F12_T0401W=b.F12_T0401d and a.F13_T0401W=b.F13_T0401d and a.F14_T0401W=b.F14_T0401d;
quit;

proc sql;
create table T_0401D_1 as select distinct a.* from broker.T_0401D_1 a,Freq_appearance_wd b
