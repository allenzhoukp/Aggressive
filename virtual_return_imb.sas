...
,sum(home_city_imb)/sum(abs(home_city_imb)) as home_city_vnor
,sum(home_province_imb)/sum(abs(home_province_imb)) as home_province_vnor
,sum(fund_imb)/sum(abs(fund_imb)) as fund_vnor
,sum(shanghai_imb)/sum(abs(shanghai_imb)) as shanghai_vnor
,sum(beijing_imb)/sum(abs(beijing_imb)) as beijing_vnor
,sum(other_imb)/sum(abs(other_imb)) as other_vnor
from broker.imb2;
quit;
...
proc sql;
create table VR_4 as select distinct stock_code_1,event_date,CAR0_1,mean(CAR) as CAR,
...
,a.home_city_CAR0_1-a.CAR0_1*b.home_city_vnor as home_city_CAR0_1
,a.home_province_CAR0_1-a.CAR0_1*b.home_province_vnor as home_province_CAR0_1
,a.fund_CAR0_1-a.CAR0_1*b.fund_vnor as fund_CAR0_1
,a.shanghai_CAR0_1-a.CAR0_1*b.shanghai_vnor as shanghai_CAR0_1
,a.beijing_CAR0_1-a.CAR0_1*b.beijing_vnor as beijing_CAR0_1
,a.other_CAR0_1-a.CAR0_1*b.other_vnor as other_CAR0_1
,a.home_city_CAR-a.CAR*b.home_city_vnor as home_city_CAR
,a.home_province_CAR-a.CAR*b.home_province_vnor as home_province_CAR
,a.fund_CAR-a.CAR*b.fund_vnor as fund_CAR
,a.shanghai_CAR-a.CAR*b.shanghai_vnor as shanghai_CAR
,a.beijing_CAR-a.CAR*b.beijing_vnor as beijing_CAR
,a.other_CAR-a.CAR*b.other_vnor as other_CAR
from VR_4 a,BS_ratio b;
quit;
*/
proc sql;
