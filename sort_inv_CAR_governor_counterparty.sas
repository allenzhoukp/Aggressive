...
proc sql;
create table &event._60d_imb as select distinct a.* from broker.all_eerbl_60d_imb_governor a,broker.all_eerbl b
...
,sum(coparty_nothome_imb_adj) as coparty_nothome_imbb10
,sum(home_city_imb_adj) as homecity_imbb10
,sum(home_notcoparty_imb_adj) as home_notcoparty_imbb10
