...
proc sql;
create table BS_ratio as select distinct F3_T0401D as stock_code_1,date
...
group by stock_code_1,date;
quit;

proc sql;
create table BS_ratio as select distinct * from BS_ratio
...
sum(a.home_city*a.BS*a.CAR0_1)/(sum(a.home_city))-b.home_city_nor*a.CAR0_1 as home_city_CAR0_1,sum(a.home_city*a.BS*a.CAR)/(sum(a.home_city))-b.home_city_nor*mean(a.CAR) as home_city_CAR,
sum(a.fund*a.BS*a.CAR0_1)/(sum(a.fund))-b.fund_nor*a.CAR0_1 as fund_CAR0_1,sum(a.fund*a.BS*a.CAR)/(sum(a.fund))-b.fund_nor*mean(a.CAR) as fund_CAR,
sum(a.shanghai*a.BS*a.CAR0_1)/(sum(a.shanghai))-b.shanghai_nor*a.CAR0_1 as shanghai_CAR0_1,sum(a.shanghai*a.BS*a.CAR)/(sum(a.shanghai))-b.shanghai_nor*mean(a.CAR) as shanghai_CAR,
sum(a.beijing*a.BS*a.CAR0_1)/(sum(a.beijing))-b.beijing_nor*a.CAR0_1 as beijing_CAR0_1,sum(a.beijing*a.BS*a.CAR)/(sum(a.beijing))-b.beijing_nor*mean(a.CAR) as beijing_CAR,
sum(a.other*a.BS*a.CAR0_1)/(sum(a.other))-b.other_nor*a.CAR0_1 as other_CAR0_1,sum(a.other*a.BS*a.CAR)/(sum(a.other))-b.other_nor*mean(a.CAR) as other_CAR,
sum(a.home_province*a.BS*a.CAR0_1)/(sum(a.home_province))-b.home_province_nor*a.CAR0_1 as home_province_CAR0_1,sum(a.home_province*a.BS*a.CAR)/(sum(a.home_province))-b.home_province_nor*mean(a.CAR) as home_province_CAR
...
sum(home_city*BS*CAR0_1)/(sum(home_city)) as home_city_CAR0_1,sum(home_city*BS*CAR)/(sum(home_city)) as home_city_CAR,
sum(fund*BS*CAR0_1)/(sum(fund)) as fund_CAR0_1,sum(fund*BS*CAR)/(sum(fund)) as fund_CAR,
sum(shanghai*BS*CAR0_1)/(sum(shanghai)) as shanghai_CAR0_1,sum(shanghai*BS*CAR)/(sum(shanghai)) as shanghai_CAR,
sum(beijing*BS*CAR0_1)/(sum(beijing)) as beijing_CAR0_1,sum(beijing*BS*CAR)/(sum(beijing)) as beijing_CAR,
sum(other*BS*CAR0_1)/(sum(other)) as other_CAR0_1,sum(other*BS*CAR)/(sum(other)) as other_CAR,
sum(home_province*BS*CAR0_1)/(sum(home_province)) as home_province_CAR0_1,sum(home_province*BS*CAR)/(sum(home_province)) as home_province_CAR
from VR_3;
where time_trade<0
