...
proc sort;
by stock_code_1 F11_T0401D F13_T0401D date event_date;
run;
...
data temp1;
set temp1;
v1=compress(F11_T0401D);
v2=compress(F13_T0401D);
drop F11_T0401D F11_T0401D;
rename v1=F11_T0401D v2=F13_T0401D;
run;
...
proc sql;
create table Event_appearance as select distinct stock_code_1,F11_T0401D,F13_T0401D,count(distinct event_date) as count,branch_province,branch_city,head_province,head_city,branch_type,head_type
from temp2
group by stock_code_1,F11_T0401D,F13_T0401D;
quit;
/*
proc sql;
...
where a.F3_T0401D=b.stock_code_1 and a.F11_T0401D=b.F11_T0401D and a.F13_T0401D=b.F13_T0401D;
quit;
...
proc sql;
create table imb5 as select distinct F3_T0401D,mean(home_city_imb) as home_city_avg,mean(home_province_imb) as home_province_avg,mean(shanghai_imb) as shanghai_avg,mean(beijing_imb) as beijing_avg,mean(other_imb) as other_avg,mean(fund_imb) as fund_avg,
